    ...
    <section className="py-20 lg:py-28 bg-gradient-to-br from-teal-600 to-teal-700">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
          ...
          <span className="block">próxima aventura?</span>
        </h2>
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-white hover:bg-gray-50 text-teal-700 font-bold px-10 py-5 rounded-full transition-all hover:shadow-2xl hover:scale-105 text-lg"
        >
